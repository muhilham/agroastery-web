    ...
    <Fragment>
      {isSearchOpen ? (
        <div className="w-full min-h-svh bg-black fixed z-50 ">
          ...
          <div>
            <div className="inline-flex justify-start items-start gap-5 p-5 thin-border w-full">
              ...
              <div className="flex flex-col gap-2">
                <h1 className="text-base text-primary uppercase">
                  HOUSE BLAND ARABICA & ROBUSTA
                </h1>
                <p className="text-sm text-secondary">
                  Arabica semi-washed dari 1600 mdpl, ideal untuk espresso dan
                  latte dengan body ringan.
                </p>
                <div className="text-primary text-sm">Rp120.000</div>
              </div>
            </div>

...
const mockProduct = {
  ...
  product_variants: [
    { id: "var-250", sku: "AGRO-5050-250", name: "250gr", price: 29370, discounted_price: null, compare_at_price: null, stock_quantity: 12, is_active: true, images: [], weight_grams: 250, product_variant_option_values: [{ option_value_id: "v1" }] },
    { id: "var-500", sku: null, name: "500gr", price: 54000, discounted_price: null, compare_at_price: null, stock_quantity: 0, is_active: true, images: [], weight_grams: 500, product_variant_option_values: [{ option_value_id: "v2" }] },
  ],
  product_faqs: [],
};

  ...
  return (
    <div className="min-h-svh flex flex-col bg-background">
      ...
      <main className="pt-24 pb-16 px-4 tablet:px-10 desktop:px-20 flex-1">
        {/* Back link */}
        <div className="h-4 w-36 bg-white/10 rounded animate-pulse mb-6" />
        ...
        {/* Shipping info */}
        <div className="rounded-xl bg-[#1a1a1a] border border-white/10 p-4 mb-4 space-y-2">
          <div className="h-4 w-32 bg-white/10 rounded animate-pulse" />
        ...
        {/* Totals */}
        <div className="rounded-xl bg-[#1a1a1a] border border-white/10 p-4 space-y-2">
